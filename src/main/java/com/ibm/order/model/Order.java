...
public class Order {
	...
	// This field is generated by MongoDB when we add an Order Document to
	...
	// We could use the generated _id field value as the unique order number but we decided
	// not to.
	
	// We're not going to use @Indexed(unique = true) - instead,
	// we'll create the index outside of the code
